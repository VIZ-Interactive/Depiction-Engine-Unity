...
namespace FastMember
{
    ...
    public abstract class TypeAccessor
    {
        ...
        {
            return Create(type, false, true, true);
        }
        ...
        /// </summary>
        /// <remarks>The accessor is cached internally; a pre-existing accessor may be returned</remarks>
        public static TypeAccessor Create(Type type, bool allowNonPublicAccessors, bool includeField = true, bool includeProperty = true)
        {
        ...
        private static bool IsFullyPublic(Type type, List<PropertyInfo> props, bool allowNonPublicAccessors)
        {
        ...
        static TypeAccessor CreateNew(Type type, bool allowNonPublicAccessors)
        {
            ...
            while (baseType != null)
            {
                ...
                props.AddRange(baseType.GetTypeAndInterfaceProperties(flags));
                baseType = baseType.BaseType;
                if (baseType == typeof(UnityEngine.MonoBehaviour) || baseType == typeof(UnityEngine.ScriptableObject))
                    baseType = null;
            }

            Dictionary<string, int> map = new Dictionary<string, int>();
            List<MemberInfo> members = new List<MemberInfo>(props.Count + fields.Count);
            int i = 0;
