...
namespace FastMember
{
    ...
    public abstract class ObjectAccessor
    {
        ...
        {
            return Create(target, false, true, true);
        }
        /// <summary>
        /// Wraps an individual object, allowing by-name access to that instance
        /// </summary>
        public static ObjectAccessor Create(object target, bool allowNonPublicAccessors, bool includeField = true, bool includeProperty = true)
        {
            ...
            return new TypeAccessorWrapper(target, TypeAccessor.Create(target.GetType(), allowNonPublicAccessors, includeField, includeProperty));
        }
