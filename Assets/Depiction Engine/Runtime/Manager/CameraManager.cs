...
namespace DepictionEngine
{
    ...
    public class CameraManager : ManagerBase
    {
        ...
        protected override void InitializeSerializedFields(InstanceManager.InitializationContext initializingState)
        {
            ...
            InitValue(value => backgroundColor = value, Color.black, initializingState);
            InitValue(value => skyboxMaterialPath = value, RenderingManager.MATERIAL_BASE_PATH + "Skybox/Star-Skybox", initializingState);
            InitValue(value => distancePass = value, Camera.DEFAULT_DISTANCE_PASS, initializingState);
            InitValue(value => environmentTextureSize = value, Camera.DEFAULT_ENVIRONMENT_TEXTURE_SIZE, initializingState);
            InitValue(value => minMaxCameraDistance = value, new Vector2Double(0.01d, MAX_CAMERA_DISTANCE), initializingState);
        }
