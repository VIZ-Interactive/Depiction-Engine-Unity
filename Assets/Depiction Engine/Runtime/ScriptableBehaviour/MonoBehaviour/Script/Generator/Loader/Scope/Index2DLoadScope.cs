...
namespace DepictionEngine
{
    public class Index2DLoadScope : LoadScope
    {
        ...
        public override void Recycle()
        {
            ...
            _indexUrlParamType = URLParametersType.ZoomXY;

            _visibleCameras = null;
        }
        ...
        public override bool RemovePersistent(IPersistent persistent)
        {
            if (base.RemovePersistent(persistent))
            {
