...
{
    public class SaveWebRequestDatasourceOperation : WebRequestDatasourceOperationBase
    {
        ...
        {
            return SaveWebRequestProcessingFunctions.PopulateOperationResult(data, parameters);
        }

        public class SaveWebRequestProcessingFunctions : DatasourceOperationProcessingFunctions
        {
