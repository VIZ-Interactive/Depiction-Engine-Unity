...
{
    //Author: Miguel Angel González Alcántara (RotaryHeart)
    //Website: https://rotaryheart.com/
    ...
    public class ReorderableList
    {
        ...
        public UnityEngine.Texture elementIcon;
        ...
        public ReorderableList(SerializedProperty list, bool canAdd, bool canRemove, bool draggable, ElementDisplayType elementDisplayType, string elementNameProperty, UnityEngine.Texture elementIcon)
            : this(list, canAdd, canRemove, draggable, elementDisplayType, elementNameProperty, null, elementIcon) { }

        public ReorderableList(SerializedProperty list, bool canAdd, bool canRemove, bool draggable, ElementDisplayType elementDisplayType, string elementNameProperty, string elementNameOverride, UnityEngine.Texture elementIcon)
        {
            if (list == null)
            {
        ...
        private void HandleDragAndDrop(Rect rect, Event evt)
        {
            switch (evt.GetTypeForControl(dragDropControlID))
            {
                ...
                case EventType.DragPerform:
                    ...
                    {
                        System.Object[] objectReferences = DragAndDrop.objectReferences;
    ...
    /// <summary>
    /// Base class that must be used for any dictionary that wants to be implemented
    /// </summary>
